...
namespace Telegram.Bot.Tests.Unit
{
    public class BaseUrlTests
    {
        ...
        {
            TelegramBotClientSpan botClient = new (token, baseUrl: baseUrl);
        ...
        {
            TelegramBotClientSpan botClient = new ("123", baseUrl: null);
        ...
        public void Should_Throw_On_Invalid_Base_Url(string invalidBaseUrl)
        {
            Assert.Throws<ArgumentException>(
                () => new TelegramBotClientSpan("123", baseUrl: invalidBaseUrl)
            );
        }
    }
}
